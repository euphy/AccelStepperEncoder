// AccelStepperEncoder.h
//
/// \mainpage AccelStepperEncoder library for Arduino
///
/// This is the Arduino AccelStepperEncoder library.
...
///
/// AccelStepperEncoder significantly improves on the standard Arduino Stepper library in several ways:
...
/// http://www.airspayce.com/mikem/arduino/AccelStepperEncoder
/// The version of the package that this documentation refers to can be downloaded 
/// from http://www.airspayce.com/mikem/arduino/AccelStepperEncoder/AccelStepperEncoder-1.38.zip
///
/// Example Arduino programs are included to show the main modes of use.
///
/// You can also find online help and discussion at http://groups.google.com/group/AccelStepperEncoder
...
/// with the exception that AccelStepperEncoder uses steps per second rather than radians per second
...
///               specifying AccelStepperEncoder::FULL4WIRE and friends.
...
// $Id: AccelStepperEncoder.h,v 1.19 2013/08/02 01:53:21 mikem Exp mikem $
...
/////////////////////////////////////////////////////////////////////
/// \class AccelStepperEncoder AccelStepperEncoder.h <AccelStepperEncoder.h>
...
/// AccelStepperEncoder will not have a correct 
...
class AccelStepperEncoder
{
public:
    /// \brief Symbolic names for number of pins.
    /// Use this in the pins argument the AccelStepperEncoder constructor to 
    ...
    /// AccelStepperEncoder::DRIVER (1) means a stepper driver (with Step and Direction pins).
    /// If an enable line is also needed, call setEnablePin() after construction.
    /// You may also invert the pins using setPinsInverted().
    /// AccelStepperEncoder::FULL2WIRE (2) means a 2 wire stepper (2 pins required). 
    /// AccelStepperEncoder::FULL3WIRE (3) means a 3 wire stepper, such as HDD spindle (3 pins required). 
    /// AccelStepperEncoder::FULL4WIRE (4) means a 4 wire stepper (4 pins required). 
    /// AccelStepperEncoder::HALF3WIRE (6) means a 3 wire half stepper, such as HDD spindle (3 pins required)
    /// AccelStepperEncoder::HALF4WIRE (8) means a 4 wire half stepper (4 pins required)
    /// Defaults to AccelStepperEncoder::FULL4WIRE (4) pins.
    /// \param[in] pin1 Arduino digital pin number for motor pin 1. Defaults
    /// to pin 2. For a AccelStepperEncoder::DRIVER (pins==1), 
    /// this is the Step input to the driver. Low to high transition means to step)
    /// \param[in] pin2 Arduino digital pin number for motor pin 2. Defaults
    /// to pin 3. For a AccelStepperEncoder::DRIVER (pins==1), 
...
//private:
	...
	/// we still keep track of the motor position so that we can work out which 
...
/// Shows how to run AccelStepperEncoder in the simplest,
...
/// Shows how to use AccelStepperEncoder to control a 3-phase motor, such as a HDD spindle motor
